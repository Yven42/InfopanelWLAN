...
//extern void WifiTask(void const * argument);
...
void StaticPrint(void)
{
	...
	strcpy(Com.u8L1,"B110");
	strcpy(Com.u8L2,"Prof. Dr. Elke Mackensen");
	strcpy(Com.u8L3,"Dekanin Fakultät EMI");
	strcpy(Com.u8L4,"Professur für");
	strcpy(Com.u8L5,"Digitale Schaltungstechnik und");
	strcpy(Com.u8L6,"mikroelektronischer");
	strcpy(Com.u8L7,"Systementwurf");
	strcpy(Com.u8L8,"Aktuelle Information");
	Com.u8G_ID=1;
